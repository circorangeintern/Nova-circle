        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <motion.div variants={container} initial="hidden" animate="show">
            ...
            >
              ...
              Nigeria's Civic Infrastructure Platform
            </motion.span>

            <motion.h1
              variants={item}
              className="mt-6 font-display text-4xl font-bold leading-[1.06] text-white sm:text-5xl lg:text-[3.4rem]"
            >
              Nigeria's Infrastructure,
              <br />
              <span className="text-accent">Made Impossible</span>
              <br />
              to Ignore.
            </motion.h1>
            ...
            >
              Document broken public infrastructure, help your community, and hold public
              institutions accountable through transparent reporting.
            </motion.p>
            ...
            <motion.ul variants={item} className="mt-9 flex flex-wrap gap-x-7 gap-y-3">
              {TRUST.map(({ icon: Icon, label }) => (
                <li key={label} className="flex items-center gap-2 text-sm font-medium text-white/85">
                  <Icon className="size-4 text-success" strokeWidth={2.2} />
                  {label}
                </li>
              ))}
            </motion.ul>
